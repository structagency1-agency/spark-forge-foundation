...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: `${SITE_FALLBACK.name} — ${SITE_FALLBACK.tagline}` },
      { name: "twitter:title", content: `${SITE_FALLBACK.name} — ${SITE_FALLBACK.tagline}` },
      { property: "og:description", content: SITE_FALLBACK.description },
      { name: "twitter:description", content: SITE_FALLBACK.description },
