...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "An enterprise-level website foundation for the SPARK TANK 4.0 innovation competition." },
      { property: "og:description", content: "An enterprise-level website foundation for the SPARK TANK 4.0 innovation competition." },
      { name: "twitter:description", content: "An enterprise-level website foundation for the SPARK TANK 4.0 innovation competition." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/339799dd-8e43-45f9-abf6-670c46716f54/id-preview-b41faca3--b019be32-1ce2-4141-a249-b7af83fbd400.lovable.app-1784015073156.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/339799dd-8e43-45f9-abf6-670c46716f54/id-preview-b41faca3--b019be32-1ce2-4141-a249-b7af83fbd400.lovable.app-1784015073156.png" },
    ],
    links: [
